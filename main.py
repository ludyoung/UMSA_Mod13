...
from pipeline.plot_metrics import plot_metricas_satisfaccion
...
def main():
    ...
    log("======================================= MASTER TABLE =============================")
    master_table = features_clean.copy()
    ...
    log("===== CÁLCULO MÉTRICAS =====")
    metricas = calcular_metricas_satisfaccion(df_master)
    log("===== GRÁFICO MÉTRICAS =====")
    plot_metricas_satisfaccion(metricas)    
